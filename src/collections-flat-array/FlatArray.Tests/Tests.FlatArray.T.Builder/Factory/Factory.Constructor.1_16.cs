...
partial class FlatArrayBuilderTest
{
    ...
    [InlineData(null)]
    [InlineData(true)]
    public void ConstructFromOneItem_ExpectInnerStateIsSourceItem(bool? item)
    {
        var actual = new FlatArray<bool?>.Builder(item);
    ...
    {
        var actual = new FlatArray<StructType?>.Builder(null, SomeTextStructType);

        const int expectedLength = 2;
        var expectedItems = new StructType?[] { null, SomeTextStructType };
    ...
    {
        var actual = new FlatArray<string>.Builder(SomeString, AnotherString, string.Empty);
    ...
    {
        var actual = new FlatArray<RefType?>.Builder(null, PlusFifteenIdRefType, MinusFifteenIdRefType, ZeroIdRefType);
    ...
    {
        var actual = new FlatArray<int>.Builder(51, 2801, -71, int.MaxValue, 67);
    ...
    {
        var actual = new FlatArray<string?>.Builder("1:One", "2:Two", "3:Three", "4:Four", "5:Five", null);
    ...
    {
        var actual = new FlatArray<double?>.Builder(
    ...
    {
        var actual = new FlatArray<uint>.Builder(
    ...
    {
        var actual = new FlatArray<string?>.Builder(
    ...
    {
        var actual = new FlatArray<byte>.Builder(
    ...
    {
        var actual = new FlatArray<int>.Builder(
    ...
    {
        var actual = new FlatArray<long>.Builder(
