...
partial class FlatArrayFlatListTest
{
    ...
    [InlineData(Zero)]
    [InlineData(One)]
    public void IndexerGet_SourceIsEmpty_ExpectArgumentOutOfRangeException(int index)
    {
    ...
    public void IndexerGet_IndexIsOutOfRange_ExpectArgumentOutOfRangeException(
