...
partial class FlatArrayTest
{
    ...
    public static TheoryData<FlatArray<byte>> CanCastArray_ValueType_TypeTheSame_ExpectTrue_CaseSource
        =>
        new()
        {
            {
    ...
    public static TheoryData<FlatArray<byte>> CanCastArray_ValueType_TypeCompatible_ExpectTrue_CaseSource
        =>
        new()
        {
            {
    ...
    public static TheoryData<FlatArray<byte>> CanCastArray_ValueType_TypeIncompatible_ExpectFalse_CaseSource
        =>
        new()
        {
            {
    ...
    public static TheoryData<FlatArray<string>> CanCastArray_RefType_TypeTheSame_ExpectTrue_CaseSource
        =>
        new()
        {
            {
    ...
    public static TheoryData<FlatArray<string>> CanCastArray_RefType_TypeCompatible_ExpectTrue_CaseSource
        =>
        new()
        {
            {
    ...
    public static TheoryData<FlatArray<object>> CanCastArray_RefType_TypeIncompatible_ExpectFalse_CaseSource
        =>
        new()
        {
            {
