...
partial class FlatArrayExtensions
{
    public static FlatArray<string> SplitToFlatArray(
        this string? source, char separator, StringSplitOptions options = StringSplitOptions.None)
    {
        if (source is null)
        {
            return default;
    ...
    public static FlatArray<string> SplitToFlatArray(
        this string? source, char separator, int count, StringSplitOptions options = StringSplitOptions.None)
    {
